...
export default function Statistics() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 items-center  gap-8 py-20 px-8 '>
      <Statistic title={'بازدید'} icon={'tv'} number={'۲۴k+'} Percent={12} bgcolor={'bg-main-red-admin'} txcolor={'text-main-red-admin'} ></Statistic>
