...
export default function Statistics() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 items-center  gap-8 mt-20 px-8 '>
      <Statistic title={'بازدید'} icon={'tv'} number={'24k+'} Percent={35} bgcolor={'bg-main-red-admin'} txcolor={'text-main-red-admin'} ></Statistic>
