            ...
            <div className="flex ">
              ...
              >
                ...
                >
                  ...
                  {showSubMenu ? (
                    <KeyboardArrowDownIcon fontSize="" className="xl:mr-[80px] md:mr-[10px] " />
                  ) : (
                    <KeyboardArrowLeftIcon fontSize="" className="xl:mr-[80px] md:mr-[10px]" />
                  )}
                </div>
                {showSubMenu && (
                  <div className="">
            ...
            <div className="flex ">
              ...
              >
                ...
                >
                  ...
                  {showSubMenu2 ? (
                    <KeyboardArrowDownIcon fontSize="" className="xl:mr-[100px] md:mr-[30px]" />
                  ) : (
                    <KeyboardArrowLeftIcon fontSize="" className="xl:mr-[100px] md:mr-[30px]" />
                  )}
                </div>
            ...
            <div className="flex ">
              ...
              >
                ...
                >
                  ...
                  {showSubMenu3 ? (
                    <KeyboardArrowDownIcon fontSize="" className="xl:mr-[85px] md:mr-[14px]" />
                  ) : (
                    <KeyboardArrowLeftIcon fontSize="" className="xl:mr-[85px] md:mr-[14px]" />
                  )}
                </div>
